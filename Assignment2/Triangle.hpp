...
public:
    Vector3f v[3]; /*the original coordinates of the triangle, v0, v1, v2 in counter clockwise order 逆时针*/
    /*Per vertex values*/
    ...
    void setColor(int ind, int r, int g, int b); /*set i-th vertex color*/
